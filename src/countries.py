...
country_acronyms = Groups({
	...
	"Argentina": [
        ...
        "argentina espanol", "buenos aires", "arroyito"
	],
	...
	"Austria": [
        ...
        "osterreich", "autriche", "rakousko", "austria deutsch"
	],
	...
	"Belgium": [
        ...
        "belgique", "belgien", "belgie", "belgica", "belgium nederlands", "belgium francais"
	],
	...
	"Bolivia, Plurinational State of": [
        ...
        "bolivia", "bolivia espanol", "la paz", "cochabamba", "el alto", "santa cruz de la sierra", "quillacollo"
	],
	...
	"Cambodia": [
        ...
        "cambodia ភាសាខ្មែរ", "cambodia english"
	],
	...
	"Canada": [
        ...
        "quebec", "canada francais", "canada english", "5018 rue harwood", "kanada"
	],
	...
	"Czechia": [
        ...
        "czech republic", "česka republika", "république tchèque", "česko", "czech republic čeština"
	],

	"Denmark": [
		"Denmark", "denmark", "DK", "DNK", "208", "ISO 3166 2:DK",
        "danemark", "denmark dansk"
	],
	...
	"France": [
        ...
        "bretagne", "normandie", "isere", "vandee", "francia", "saint philibert", "provence", "frankreich", "alsace", "angle", "frankrijk", "corsica", "francia espana", "france francais", "franca", "franciaorszag", "brittany", "normandy", "lait origine france", "porc origine france", "pays de la loire", "finistere", "vendee", "morbihan", "rhone alpes", "ille et vilaine", "nord pas de calais", "savoie", "cotes d armor", "sarthe", "loire atlantique", "calvados", "pas de calais", "loiret", "basse normandie", "29260 ploudaniel", "centre val de loire", "naturalim za quartier bel air 39330 port lesney france", "drome",
	],
	...
	"Germany": [
        ...
        "deutschland", "allemagne", "alemania", "germania", "tyskland", "schleswig holstein", "německo", "германия", "germany deutsch"
	],
	...
	"Greece": [
        ...
        "grece", "ελλάδα", "grèce", "greece ελληνικά"
	],
	...
	"India": [
        ...
        "indian subcontinent", "india english"
	],

	"Indonesia": [
		"Indonesia", "indonesia", "ID", "IDN", "360", "ISO 3166 2:ID",
        "indonesie", "indonesia bahasa indonesia", "indonésie"
	],
	...
	"Ireland": [
        ...
        "irlande", "irland", "ireland english"
	],
	...
	"Italy": [
        ...
        "italie", "italia", "italien", "sardinia", "italy italiano"
	],
	...
	"Malaysia": [
        ...
        "malaisie", "malaysia bahasa melayu", "malaysia english", "malaysia 中文", "johor" 
	],
	...
	"Mexico": [
        ...
        "ciudad de mexico", "estado de mexico", "guanajuato", "jalisco", "cdmx", "durango", "mexique", "mexico espanol"
	],
	...
	"Netherlands, Kingdom of the": [
        ...
        "pays bas", "netherlands", "niederlande", "nederland", "netherlands nederlands"
	],
	...
	"North Macedonia": [
        ...
        "republic of macedonia", "north macedonia македонски јазик"
	],
	...
	"Poland": [
        ...
        "polska", "pologne", "polen", "poland polski"
	],
	...
	"Russian Federation": [
        ...
        "russia", "russia русский", "абхазия", "soviet union"
	],
	...
	"Serbia": [
        ...
        "kosovo", "republika srpska", "serbia srpski",
	],
	...
	"Spain": [
        ...
        "espagne", "espana", "spanien", "cantabria", "santona", "spain espanol", "cordoba", "andalucia", "comunidad valenciana", "cataluna", "castilla y leon", "navarra", "castilla la mancha", "madrid comunidad autonoma", "valencia provincia", "murcia comunidad autonoma"
	],
	...
	"Sweden": [
        ...
        "sverige", "sweden svenska",
	],

	"Switzerland": [
		"Switzerland", "switzerland", "CH", "CHE", "756", "ISO 3166 2:CH",
        "suisse", "schweiz", "suiza", "švýcarsko", "switzerland francais", "switzerland deutsch"
	],
	...
	"Thailand": [
        ...
        "thailande", "thailand ไทย", "ประเทศไทย thai"
	],
	...
	"United Kingdom of Great Britain and Northern Ireland": [
        ...
        "united kingdom", "royaume uni", "uk", "UK", "angleterre", "scotland", "england", "united kingdom english", "london", "ecosse",
	],

	"United States of America": [
		"United States of America", "united states of america", "US", "USA", "840", "ISO 3166 2:US",
        "united states", "usa", "estados unidos", "etats unis", "vereinigte staaten von amerika", "united states english", "united states espanol", "stany zjednoczone", "santa cruz"
	],
